...
1. Open your **Command Prompt** or **Powershell** and open the `R` prompt by typing `R`
...
All the important key features, ranging from very **basic** to **Advance** are discussed [here](https://aravpatil000.github.io/quarto-web/posts/J018_R_Coding.html).
...
**All the above mentioned domains are discussed using examples which showcases `dplyr`'s usability in them. [Click here](https://aravpatil000.github.io/quarto-web/posts/J018_Exposition.html) to explore them.**
---
