...
**Moreover, if you wish to use `R` in `Jupyter Notebook` like we have, you watch the [tutorial](https://www.youtube.com/watch?v=1sq-Pcq9W7c&t=207s) and configure your environment.**
---
